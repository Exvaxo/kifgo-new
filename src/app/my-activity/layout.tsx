    ...
    <section className="h-[100dvh] overflow-hidden bg-gray-950 p-2">
      <main className="relative flex h-full w-full flex-grow items-start justify-start overflow-hidden rounded-2xl bg-white transition-all duration-150">
        <div className="min-h-[100dvh] w-full">
          ...
          <header className="border-b border-t py-1">
          ...
          <div className="mx-auto mt-10 flex h-full w-full max-w-screen-lg items-start justify-between">
            {/* sidebar */}
            <aside className="hidden w-[30%] md:block">
              <Sidebar />
            </aside>
            ...
            {/* content */}
            <div className="h-[70dvh] w-full px-5 md:w-[70%] md:px-0">
              {children}
            </div>
            {/* content */}
          </div>
