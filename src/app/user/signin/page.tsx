...
const Signin = () => {
  ...
  const { fetchUserLoading, googleLoading, emailPaswordLoading } =
    useAuthStore();
  return (
    <section className="h-[100dvh] bg-gray-950 p-2">
      <div className="flex h-full w-full overflow-hidden rounded-2xl bg-white">
        ...
        <div className="relative flex h-full w-[50%] grow flex-col overflow-y-auto overflow-x-hidden">
          {!fetchUserLoading && !emailPaswordLoading && !googleLoading ? (
            <>
                ...
                <div className="flex w-full flex-col items-center justify-center">
                  ...
                  {searchParams &&
                    (!searchParams.get("step") ||
                      ...
                      <>
                        <h1 className="mt-5 text-2xl">Welcome to Kifgo</h1>
                        <p className="mt-1 text-sm text-gray-600">
                          Manage your Kifgo account
                        </p>
                  ...
                  {searchParams &&
                    ...
                    searchParams.get("step") === "2" && (
                      <>
                        <h1 className="mt-5 text-2xl">Secure your account</h1>
                        <p className="mt-1 text-sm text-gray-600">
                          Manage your Kifgo account
                        </p>
                  ...
                  <p className="mt-14 w-full max-w-xs text-center text-[0.65rem] text-gray-500">
                    By clicking Continue with Google you agree to Kifgos&apos;s{" "}
                    <br />{" "}
                    <a
                      href="#"
                      target="_blank"
